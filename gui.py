...
class LOLCodeInterpreter:
    def __init__(self):
        ...
        self.execute_btn.grid(row=1, column=0, columnspan=1, sticky="ew", pady=pane_pad, padx=pane_pad)

        self.clear_btn = Button(self.frame, text="Clear", command=self.clear)
        self.clear_btn.grid(row=1, column=1, columnspan=2, sticky="ew", pady=pane_pad, padx=pane_pad)
